...
#                                            NOTE!!!!
#
# This files was an attempt by a previous term to set up tabs in Tkinter to simultaneously load
...
# extract the method from VocalDataBlock.get_file_name(), place it in a seperate file, and delete
# this one
#
# Collin Pampalone @CPampalone
# 7/19/17
#
####################################################################################################
