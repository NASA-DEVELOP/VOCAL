...
class AdvancedSearchDialog(Toplevel):
    ...
    def __init__(self, parent, root):
        ...
        Label(bottom_window_frame, text='Time Range ').grid(row=1, column=0, padx=5, pady=5, sticky='w')
        Label(bottom_window_frame, text='Latitude Range ').grid(row=2, column=0, padx=5, pady=5, sticky='w')
        Label(bottom_window_frame, text='File ').grid(row=3, column=0, padx=5, pady=5, sticky='w')
        ...
        Label(bottom_window_frame, text='to').grid(row=1, column=2, pady=5, sticky='w')
        self.e_time_entry = Entry(bottom_window_frame, width=10)
        self.e_time_entry.grid(row=1, column=3, padx=5, pady=5, sticky='w')

        self.am_pm_menu = OptionMenu(bottom_window_frame, self.am_pm, 'am', 'pm')
        self.am_pm_menu.grid(row=1, column=4, pady=5, sticky='w')

        self.b_lat_entry = Entry(bottom_window_frame, width=10)
        self.b_lat_entry.grid(row=2, column=1, padx=5, pady=5, sticky='w')
        Label(bottom_window_frame, text='to').grid(row=2, column=2, pady=5, sticky='w')
        self.e_lat_entry = Entry(bottom_window_frame, width=10)
        self.e_lat_entry.grid(row=2, column=3, padx=5, pady=5, sticky='w')

        self.file_entry = Entry(bottom_window_frame, width=25)
        self.file_entry.grid(row=3, column=1, padx=5, pady=5, sticky='w', columnspan=4)
